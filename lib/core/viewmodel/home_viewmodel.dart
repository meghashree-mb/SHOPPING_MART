...
import 'package:shoppingmart/core/services/firestore_home.dart';
import 'package:shoppingmart/model/category_model.dart';
import 'package:shoppingmart/model/product_model.dart';
...
class HomeViewModel extends GetxController {
  ...
  _getProductsFromFireStore() async {
    _loading = true;
    List<QueryDocumentSnapshot> productsSnapshot = await FirestoreHome().getProductsFromFirestore();
