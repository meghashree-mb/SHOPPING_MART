                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(
                                         ...
                                         CustomText(
                                          text: 'Estimated Delivery Time : 4-5 days',
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold,
        ...
        children: [
                ...
                return Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      CustomText(
                        text:
                            '\u{20B9} ${controller.cartProducts[index].price} x ${controller.cartProducts[index].quantity}',
                        fontSize: 14,
                        color: primaryColor,
                      ),
                    ],
          ...
          Row(
            ...
            children: [
              ...
              CustomText(
                text: '\u{20B9}${controller.totalPrice.toString()}',
                fontSize: 16,
                fontWeight: FontWeight.bold,
                color: primaryColor,
              ),
